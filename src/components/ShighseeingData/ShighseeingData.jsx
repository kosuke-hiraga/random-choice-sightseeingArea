...
import { useGetSightseeingData } from "../../hooks/hooks";
...
const SightseeingData = (data) => {
    ...
    // console.log(document.getElementById("uu"));

    const [sliderValue, setSliderValue] = useState(1);

    const [querySnapshot_random, setquerySnapshot_random] = useState({});

    // const unti = useGetSightseeingData();

    function excute2(sliderValue) {
        // const t = useGetSightseeingData(sliderValue)
        // setquerySnapshot_random(t);
    }
    ...
    async function GetSightseeingData(numberOfRecordsYouWant) {
    ...
    function updateSliderValue(e, value) {
        console.log(value);
    ...
    return (
        <>
            ...
            <button onClick={() => GetSightseeingData(sliderValue)}>show useGetSightseeingData</button>
            {/* <button onClick={() => useGetSightseeingData(sliderValue)}>undei deee</button> */}
            <button onClick={() => excute2(sliderValue)}>undei deee</button>
